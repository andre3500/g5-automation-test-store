...
it('Log in 2-01 - Incorrect Password - Test 1', () => {
...
it('Log in 2-02 - Incorrect Password - Test 2', () => {
    cy.visit('/index.php?rt=account/login');
    ...
    it('Log in 2-03 - Incorrect Password - Test 3: reset', () => {
        cy.visit('/index.php?rt=account/login');
...
it('Log in 3-01 - Incorrect Username - Test 1', () => {   
     cy.visit('/index.php?rt=account/login');
...
it('Log in 3-02 - Incorrect Username - Test 2', () => {   
     cy.visit('/index.php?rt=account/login');
...
it('Log in 3-03 - Incorrect Username - Test 3', () => {   
     cy.visit('/index.php?rt=account/login');

cy.log('**Click Forgot Username ...**');
...
cy.log('**Username Reset - empty username...**');
